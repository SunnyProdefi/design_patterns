...
{
public:
    int applyDiscount(int originalPrice) override { return static_cast<int>(std::round(originalPrice * 0.9)); }
};
...
public:
    ...
    int applyDiscount(int originalPrice) { return discountStrategy->applyDiscount(originalPrice); }
};
