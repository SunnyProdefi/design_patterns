...
{
public:
    void makeDrink(const std::string& drinkName) { std::cout << drinkName << " is ready!" << std::endl; }
};
...
void OrderCommand::execute() { receiver->makeDrink(drinkName); }
...
public:
    ...
    void executeOrder() { command->execute(); }
};
